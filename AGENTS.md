# AGENTS.md — LLD Practice Repository

This file governs how Codex assists in this repository. All work here is **Java LLD interview preparation**. Follow every rule below without shortcuts.
